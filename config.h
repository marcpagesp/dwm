...
#if BAR_PANGO_PATCH
static const char font[]                 = "JetBrainsMono Nerd Font:size=15";
#else
...
static Key keys[] = {
	...
	TAGKEYS(                        XK_6,                                  5)
        ...
        {0, XF86XK_MonBrightnessUp, spawn, SHCMD("brightnessctl set +5% && pkill -RTMIN+1 dwmblocks")},
        {0, XF86XK_MonBrightnessDown, spawn, SHCMD("brightnessctl set 5%- && pkill -RTMIN+1 dwmblocks")},
        {0, XF86XK_Calculator, spawn, SHCMD("deepin-calculator")},
